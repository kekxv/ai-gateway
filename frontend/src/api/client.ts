...
const apiErrorMessages: Readonly<Record<string, string>> = {
  ...
  balance_detection_failed: '余额接口检测失败，请手动选择上游类型',
  balance_query_not_configured: '请先配置上游余额查询',
  balance_query_unavailable: '余额查询服务不可用',
  balance_sync_failed: '余额同步失败，请检查上游余额接口配置',
  credential_required: '请提供凭据',
  current_totp_required: '请输入当前双重验证验证码',
  duplicate_provider_protocol: '供应商协议配置重复',
  email_exists: '邮箱已被注册',
  invalid_api_key: '接口密钥无效',
  invalid_balance_config: '余额查询配置无效',
